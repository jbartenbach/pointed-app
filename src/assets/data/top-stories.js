const stories = [
  {
    ...
    label: "welcome",
    title: "Short Stories the fun way",
    author: "Jeff Bartenbach",
    shortbody: "Pointed Stories is a new way to enjoy short stories. It’s quite simply a feed of the best stories, from the classics to contemporary writers.",
    longbody: [
      `Pointed Stories is a new way to enjoy short stories. It’s quite simply a feed of the best stories, from the classics to contemporary writers.`,
      `Vestibulum eget purus interdum, hendrerit felis vel, tristique diam. Curabitur ut facilisis risus. Quisque luctus diam sed nulla eleifend, vitae finibus nisi euismod. Ut dictum metus vitae nisl porta tempor. Nam commodo sagittis felis, vel sodales turpis hendrerit at. Aenean ac diam ullamcorper arcu efficitur varius.`,
      `If you’d like to see your story on Pointed Stories, please send your manuscript along with your contact information to jeff@pointedstories.com`
    ]
  },
  {
    id: 2,
    label: "Short Story",
    title: "A Great Title for the Ages",
    author: "John Doe",
    shortbody: "This is an example of a card without an image. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec viverra odio.",
    longbody: [
      `This is an example of a card without an image. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec viverra odio.`,
      `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec viverra odio. Sed viverra nisl bibendum quam finibus luctus. Nam id elit ac libero fringilla malesuada. Nullam eget nulla at risus auctor pulvinar. Duis pulvinar elit at nulla pharetra, id tincidunt diam dictum. Aliquam finibus elit sed risus molestie tristique. In mollis luctus lacus a venenatis. Duis rutrum justo ut rutrum egestas. Curabitur et arcu sollicitudin, fermentum lacus ut, molestie ipsum. Integer leo nisi, fringilla quis ante et, sollicitudin sodales dolor. Sed luctus, risus vitae sodales ullamcorper, velit est convallis justo, id rhoncus metus nisi vitae massa. Nullam bibendum tincidunt magna a suscipit. Sed condimentum fringilla metus. Morbi luctus ante sit amet iaculis facilisis.`,
      `Vestibulum eget purus interdum, hendrerit felis vel, tristique diam. Curabitur ut facilisis risus. Quisque luctus diam sed nulla eleifend, vitae finibus nisi euismod. Ut dictum metus vitae nisl porta tempor. Nam commodo sagittis felis, vel sodales turpis hendrerit at. Aenean ac diam ullamcorper arcu efficitur varius. Praesent sed venenatis velit, nec ornare orci. Sed venenatis lorem vel metus vulputate, non accumsan diam facilisis. Morbi malesuada odio et augue mattis, quis rutrum justo elementum. Donec eleifend arcu venenatis efficitur rhoncus. Sed nunc diam, tempor ut cursus eget, mattis id mauris.`,
      `Etiam eros augue, dictum vel massa ut, tempor commodo urna. Sed sed ligula eget dolor bibendum sollicitudin. Ut a viverra sapien, ut mollis eros. Nulla venenatis eget massa eget dictum. Nunc ultrices massa non lectus eleifend volutpat a lacinia magna. Nam eu arcu consectetur, euismod eros sed, luctus sapien. Nunc tempor faucibus sagittis. Pellentesque ultrices risus vel nulla tempor vulputate. Suspendisse ac eleifend ante. Mauris ut mattis orci.`
    ]
  },
  {
    id: 3,
    ...
    title: "Short Title",
    author: "John Doe",
    shortbody: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec viverra odio. Sed viverra nisl bibendum quam finibus luctus",
    longbody: [
      `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec viverra odio. Sed viverra nisl bibendum quam finibus luctus`
    ]
  },
  {
    id: 4,
    label: "Short story",
    title: "An Extremely Long Title with Some Overwhelmingly Long Words",
    author: "John Doe",
    shortbody: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec viverra odio. Sed viverra nisl bibendum quam finibus luctus",
    longbody:[
      `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec viverra odio. Sed viverra nisl bibendum quam finibus luctus`
  ...
  },
  {
    ...
    author: "H.G. Wells",
    shortbody: `I had seen the Magic Shop from afar several times; I had passed it once or
